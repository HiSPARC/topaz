...
def analyse_reconstructions(data):
    ...
    succesful_fraction = 100.0 * succesful_direction / total_count
    print('%.2f%% successful out of %d coincidences' % (succesful_fraction, total_count))
    ...
    succesful_fraction_d = 100.0 * succesful_direction_d / total_count_d
    print('%.2f%% successful out of %d coincidences' % (succesful_fraction_d, total_count_d))

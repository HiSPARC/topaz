...
def reconstruct_simulations(path):
    with tables.open_file(path, 'a') as data:
        ...
        for station in cluster.stations:
            ...
            rec_events = ReconstructESDEvents(data, station_group, station, overwrite=True, progress=False)
        ...
        rec_coins = ReconstructESDCoincidences(data, '/coincidences', overwrite=True, progress=False)

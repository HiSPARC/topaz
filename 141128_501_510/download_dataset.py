...
def download_501_510_dataset():
    ...
    with tables.open_file('c_501_510_141001_141011.h5', 'a') as data:
        download_coincidences(data, stations=stations, start=start, end=end, n=2)

    with tables.open_file('e_501_510_141001_141011.h5', 'a') as data:
    ...
    with tables.open_file('c_501_510_141101_141111.h5', 'a') as data:
        download_coincidences(data, stations=stations, start=start, end=end, n=2)

    with tables.open_file('e_501_510_141101_141111.h5', 'a') as data:
        download_data(data, '/s501', 501, start=start, end=end)
        download_data(data, '/s510', 510, start=start, end=end)
